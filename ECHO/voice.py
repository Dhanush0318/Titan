...
while True:
    ...
    elif 'visit GoDaddy website' and 'MongoDB' and 'Streamlit' and 'Taipy'  and 'Hedera' and 'Cloudflare' in user_command:
        speak_ex('Visiting ' + user_command + '  website.')
    elif 'Addition' and 'Subtraction' and 'Multiplicaton' and 'Division' in user_command:
        speak_ex('Doing '+ user_command + 'process')
